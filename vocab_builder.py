...
models = [#"hsb_fam", "hsb_geo", "hsb_phon", 
        "lg_fam", 
        #"lg_geo", "lg_phon", "tt_fam", "tt_geo", "tt_phon", "rand"
        ]
...
for m in models:
    ...
    vocab = build_vocab_from_dataset(train, test, f"/scratch/jliebl/ASR_ComputEL/Models/{m}/vocab.json")
